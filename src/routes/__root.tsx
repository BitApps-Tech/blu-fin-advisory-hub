...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BluFin Capital Advisory — Licensed Securities Investment Advisor" },
      { name: "description", content: "BluFin Capital Advisory PLC is a licensed Securities Investment Advisor regulated under the Ethiopian Capital Market Authority. Corporate finance, listing solutions, transaction advisory, and private equity." },
      { property: "og:title", content: "BluFin Capital Advisory" },
      { property: "og:description", content: "Institutional-grade capital markets advisory. ECMA-licensed." },
