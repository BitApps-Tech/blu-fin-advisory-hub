    ...
    <>
      <section className="hairline-b bg-background">
        <div className="container-editorial py-20 md:py-28">
          ...
          <h1 className="mt-6 max-w-4xl font-serif text-5xl text-navy md:text-6xl">{t.about.headline}</h1>
      ...
      <section className="hairline-b bg-panel">
        <div className="container-editorial py-20 md:py-24">
          ...
          <h2 className="mt-4 max-w-2xl font-serif text-3xl text-navy md:text-4xl">{t.about.legalTitle}</h2>
      ...
      <section className="hairline-b bg-background">
        <div className="container-editorial grid gap-16 py-24 md:grid-cols-12">
          ...
          <div className="space-y-6 md:col-span-8">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">{c.foundingPhilosophy}</p>
          </div>
        </div>
      </section>
      ...
      <section className="hairline-b bg-background">
        <div className="container-editorial grid gap-12 py-24 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-muted-foreground">{c.visionElaboration}</p>
          </div>
          <div>
            <div className="eyebrow">{t.about.mission}</div>
            <h2 className="mt-6 font-serif text-3xl text-navy md:text-4xl">{c.mission}</h2>
            <p className="mt-6 text-sm leading-relaxed text-muted-foreground">{c.missionElaboration}</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background">
        <div className="container-editorial py-24">
          ...
          <div className="hairline-t mt-12 grid grid-cols-1 md:grid-cols-2">
            {c.values.map((v, i) => (
              <div key={v.title} className={`hairline-b p-8 md:p-10 ${i % 2 === 0 ? "md:hairline-r" : ""}`}>
          ...
          <Link to="/contact" className="mt-12 inline-flex items-center gap-2 text-xs uppercase tracking-widest text-navy hover:underline">
