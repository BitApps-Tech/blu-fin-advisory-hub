  ...
  return (
    <section className="hairline-b bg-background">
      <div className="container-editorial py-20 md:py-24">
        ...
        <div className="mx-auto mt-14 max-w-3xl border border-hairline bg-panel">
          <div className="flex flex-col gap-8 p-8 md:flex-row md:items-start md:gap-10 md:p-12">
            <div className="flex h-20 w-20 shrink-0 items-center justify-center bg-navy text-navy-foreground">
