/** Sourced from BluFin Capital Advisory Company Profile. */
export const COMPANY = {
  legalName: "BluFin Capital Advisory PLC",
  tradingName: "BluFin Capital Advisory",
  legalForm: "Private Limited Company (PLC)",
  commercialRegistrationNo: "EIA/PC/2/0002292/2018",
  tin: "0100327611",
